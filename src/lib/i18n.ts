...
const DICT: Record<Lang, Record<string, string>> = {
  pt: {
    "me": "eu",
    "sidebar.empty": "Nenhum contato ainda.",
    ...
    "chat.renameTip": "Renomear contato",
    "chat.removeTip": "Remover contato",
    "chat.aiTip": "Assistente de IA local",
    "chat.kwTip": "Palavra-chave de verificação",
    "chat.renamePrompt": "Apelido do contato",
    "chat.removeConfirm": "Remover este contato e sair da conversa?",
    ...
    "kw.prompt": "Palavra-chave combinada com este contato (deixe vazio pra remover):",
    "kw.changedByPeer": "mudou a palavra-chave — atualize a sua pra conferir",
  ...
  es: {
    "me": "yo",
    "sidebar.empty": "Aún no hay contactos.",
    ...
    "chat.renameTip": "Renombrar contacto",
    "chat.removeTip": "Eliminar contacto",
    "chat.aiTip": "Asistente de IA local",
    "chat.kwTip": "Palabra clave de verificación",
    "chat.renamePrompt": "Apodo del contacto",
    "chat.removeConfirm": "¿Eliminar este contacto y salir de la conversación?",
    ...
    "kw.prompt": "Palabra clave acordada con este contacto (vacío para quitar):",
    "kw.changedByPeer": "cambió la palabra clave — actualiza la tuya para verificar",
  ...
  en: {
    ...
    "chat.renameTip": "Rename contact",
    "chat.removeTip": "Remove contact",
    "chat.aiTip": "Local AI assistant",
    "chat.kwTip": "Verification keyword",
    "chat.renamePrompt": "Contact nickname",
    "chat.removeConfirm": "Remove this contact and leave the conversation?",
    ...
    "kw.prompt": "Keyword agreed with this contact (empty to remove):",
    "kw.changedByPeer": "changed the keyword — update yours to verify",
